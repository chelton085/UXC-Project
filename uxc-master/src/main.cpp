...
#if defined(NDEBUG)
# error "ultraxcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ultraxcoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 4 * 60;  // 4 mins
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    if (pindexBest->nHeight > 3 && pindexBest->nHeight < 80)
...
{
    RenameThread("ultraxcoin-loadblk");
